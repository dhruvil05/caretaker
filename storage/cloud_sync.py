...
class CloudSync:
    ...
    def initialize(self) -> bool:
        ...
        try:
            from storage.encrypt import Encryptor
    ...
    def push_all(self) -> dict:
        ...
        from storage.encrypt import encrypt_memory_dict
    ...
    def pull_all(self) -> dict:
        ...
        from storage.local_db import get_connection, save_memory
        from storage.encrypt import decrypt_memory_dict

...
from cli.commands.view_cmd    import view_cmd
from cli.commands.search_cmd  import search_cmd
from cli.commands.edit_cmd    import edit_cmd
from cli.commands.delete_cmd  import delete_cmd
from cli.commands.restore_cmd import restore_cmd
from cli.commands.stats_cmd   import stats_cmd
from cli.commands.export_cmd  import export_cmd
from cli.commands.import_cmd  import import_cmd
from cli.commands.sync_cmd    import sync_cmd
from cli.commands.config_cmd  import config_cmd
from cli.formatters           import BOLD, RESET, CYAN, GREY, GREEN, YELLOW
...
def maintenance_cmd():
    ...
    try:
        from scheduler.scheduler import run_maintenance_now
...
def score_cmd(memory_id, value):
    ...
    from cli.formatters import print_success, print_error, print_info
